  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center justify-center text-center px-4 py-24">
        ...
        <h1 className="text-5xl font-medium text-gray-900 mb-6 max-w-2xl leading-tight">
        ...
        <div className="flex gap-4">
          <Link
            to="/analyze"
            className="bg-purple-600 text-white px-8 py-3 rounded-lg text-sm font-medium hover:bg-purple-700"
          >
            Analyze my resume
          </Link>
          <Link
            to="/register"
            className="border border-gray-200 text-gray-700 px-8 py-3 rounded-lg text-sm font-medium hover:bg-gray-50"
          >
            Create free account
          </Link>
        </div>
      ...
      {/* Features Section */}
      <div className="grid grid-cols-3 gap-6 max-w-4xl mx-auto px-8 pb-24">
      ...
      <div className="bg-gray-50 py-20 px-8">
        ...
        <div className="flex justify-center items-center gap-6 max-w-3xl mx-auto">
